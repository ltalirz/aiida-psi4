...
Check version number in setup.json and aiida_psi4/__init__.py and make sure
they match.
"""
# -*- coding: utf-8 -*-
...
import aiida_psi4  # pylint: disable=wrong-import-position
VERSION = aiida_psi4.__version__
