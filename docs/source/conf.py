# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-psi4
#
...
project = u'aiida-psi4'
copyright_first_year = '2021'
copyright_owners = 'Leopold Talirz'
...
release = aiida_psi4.__version__
...
html_use_opensearch = 'http://aiida-psi4.readthedocs.io'
...
htmlhelp_basename = 'aiida-psi4-doc'
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'aiida_psi4')
...
nitpick_ignore = [('py:class', 'qcelemental.models.results.AtomicInput')]
